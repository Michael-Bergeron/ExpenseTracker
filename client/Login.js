  ...
  return (
    <div style = {pageStyle}>
      {showLogin ? (
        ...
        <div style = {{position: 'relative', left: '280px', top: '0px', width: '400px', height: '440px', padding: '20px', 'background': 'white'}}>
          ...
          {props.loginError === '' ? (<></>) : (<p style = {{position: 'aboslute', color: 'red', fontSize: '10px'}}>{props.loginError}</p>)}
